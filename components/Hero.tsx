...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-28 md:pt-36">
      <div className="container-page grid items-end gap-8 lg:grid-cols-12">
        <div className="order-2 lg:order-1 lg:col-span-7 lg:pb-10">
          <Reveal>
            <p className="kicker">{hero.kicker}</p>
            <h1 className="display mt-6 max-w-[13ch] text-[clamp(2.8rem,7.4vw,6.6rem)]">
              {hero.title}
            </h1>
            <p className="mt-6 max-w-xl text-[1.08rem] leading-relaxed text-muted text-pretty md:text-lg">
              {hero.lead}
            </p>
        ...
        <div className="relative order-1 lg:order-2 lg:col-span-5 lg:-mr-10 xl:-mr-20">
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[120%] w-[120%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(255,61,31,0.35),rgba(255,176,80,0.18)_42%,transparent_68%)] blur-2xl" />
          <BookStage />
        </div>
      </div>
